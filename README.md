...
<p style="color: yellow;">And use "flutter doctor" in Command Prompt to check the status. It should display all green checkmarks.</p>

<strong style="font-size: 20px;">Example screen</strong><br>
